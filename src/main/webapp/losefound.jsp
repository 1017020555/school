...
<div class="list-group" id="lists" style="margin-left: 90px;">
    ...
    <a href="${pageContext.request.contextPath}/lose/losefound" class="list-group-item active">
        发布捡到物品通告：
    </a>
...
<div id="title2" class="alert alert-info" role="alert" style="margin-top: -200px;">
    <img src="${pageContext.request.contextPath}/img/img1.png">
    <label>发布捡到物品信息：</label>
</div>

<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/lose/losefound2">
    <div id="title3">
        <table>
            <tr>
                <td>
                    <label style="margin-left: 50px;">捡到物品类别：</label>
            ...
            <tr>
                <td>
                    <label>捡到物品名称：</label>
                    <input name="goodname" style="margin-left:40px;width: 240px;display: inline;" type="text" class="form-control" placeholder="捡到物品名称：">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <label>描述：</label>
                    <textarea name="goodexplain" class="form-control" rows="8" cols="8"></textarea>
                </td>
            </tr>
            <tr>
                <td>
