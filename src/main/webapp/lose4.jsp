        ...
        <ul class="nav nav-pills nav-stacked">
                <li>
                    <div style="width: 600px;">
                        <img src="/upload/${good.photo}" style="width: 300px;height: 200px;" alt="图片" class="img-thumbnail"><br>
                        <label class="form-control">名称：${good.goodname}</label><br>
                        <label class="form-control">地点：${good.place}</label><br>
                        <label class="form-control">时间：
                            <fmt:formatDate value="${good.time}" pattern="yyyy-MM-dd"/>&nbsp;
                        </label><br>
                        <textarea class="form-control" cols="4" rows="4">${good.goodexplain}</textarea>
                    </div>
                </li>
        </ul>
</div>
